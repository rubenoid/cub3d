...
/*   Updated: 2020/08/24 19:24:40 by rvan-sch      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_get_texture_info(t_cub *cub, t_mlx *mlx)
{
	int i;
...
int			ft_init_mlx(t_mlx *mlx, t_cub *cub)
{
	...
	if (mlx->tex_width[4] != mlx->tex_height[4] ||
		mlx->tex_width[5] != mlx->tex_height[5] ||
		mlx->tex_width[6] != mlx->tex_height[6])
		perror("Warning: sprite is not square,"
				"this might result in undefined behaviour");
	if (mlx->tex_width[5] > 256 || mlx->tex_height[5] > 256 ||
		mlx->tex_width[6] > 256 || mlx->tex_height[6] > 256)
		perror("Warning: floor/ceiling sprite might be to big");
